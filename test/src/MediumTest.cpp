...
TEST( MediumTest, operator2 )
{
    Medium medium1{};
    Medium medium2{};

    medium1.operator==(medium2);
    EXPECT_EQ(medium1,medium2);
}

TEST( Medium, operator1 )
{
    Medium medium1{};
    const Medium medium2{};


    medium1.operator<( medium2 );
    EXPECT_LT( medium1.data , medium2.data );
