...
TEST( SmallTest, operator2 )
{
    Small small1{};
    Small small2{};

    small1.operator==(small2);
    EXPECT_EQ(small1,small2);
}

TEST( SmallTest, operator1 )
{
    Small small1{};
    const Small small2{};
    ...
    small1.operator<( small2 );
    EXPECT_LT( small1.data , small2.data );

}
TEST( SmallTest, operator3 )
{
    Small small1{};
    Small small2{};
    const Small d{};
    //std::set<Small,std::hash<small1>>
}
